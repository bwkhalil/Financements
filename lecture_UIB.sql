...
(		
	...
	where RegParam_Code in ('rbf') and Reg_RegCpt=0 /*and reg_num in( 'RF20Tr777')*/ and year(reg_dateecheance)>=2020 and reg_banque like '%uib%'  --and (reg_ref is not null or reg_ref1 is not null)

...
,reg_datereglement,Reg_DateEcheance
from reglement
where RegParam_Code in ('dtc')  and year(reg_dateecheance)>=2020 and (reg_ref is not null or reg_ref1 is not null)
 and reg_banque like '%biat%' /*and  reg_num ='RF20Tr692' and Reg_RegCpt=0*/  and abs(datediff(day, reg_datereglement,reg_dateecheance))>=50
)
